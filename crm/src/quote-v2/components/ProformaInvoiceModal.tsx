...
const wordTemplateUrl = (name: "proforma-invoice" | "internal-cost-sheet") => {
    const filename = name === "proforma-invoice" ? "proforma_invoice_template.docx" : "internal_cost_sheet_template.docx";
    const url = new URL(`/quote-v2/templates/${filename}`, window.location.origin);
